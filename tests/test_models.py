...
class TestAuthor:
    ...
    def test_author_full(self):
        ...
        author = Author(name="Jane Smith", affiliation="MIT", email="jane@mit.edu")
...
class TestPaperMetadata:
    ...
    def test_metadata_minimal(self):
        ...
        metadata = PaperMetadata(
            arxiv_id="2301.00001", title="Test Paper", abstract="This is a test abstract"
        )
...
class TestPaper:
    ...
    def test_paper_creation(self):
        ...
        metadata = PaperMetadata(
            arxiv_id="2301.00001", title="Test Paper", abstract="Test abstract"
        )
...
class TestFetcherConfig:
    ...
    def test_config_custom(self):
        ...
        config = FetcherConfig(
            headless=False, timeout=30000, download_pdfs=False, cache_enabled=False
        )
